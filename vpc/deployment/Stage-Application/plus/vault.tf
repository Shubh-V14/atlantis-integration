  ...
  policy                   = jsonencode(
            ...
            Statement = [
      {
        ...
        "AWS"= [
          ...
          "arn:aws:iam::${local.upswing_stage_application_account_id}:root"
        ]
        },
        "Action"= "kms:*",
        "Resource"= "*"
   ...
   tags = {
      Environment = "stage"
      Name        = "vault_autounseal"
    }
}

output "vault_autounseal_key_arn"{
...
locals {
    ...
    oidc_provider_url = "oidc.eks.ap-south-1.amazonaws.com/id/7CA822C2A338819E7ABCD37B2812B47F"
}
